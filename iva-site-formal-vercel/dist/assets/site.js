(function(){
 ...
 function mountYouTubeVideos(){
  ...
  const ids={index:'1W6M76vCo1Q',iva:'tlsQ31IUC7s',suitability:'9Mx8edVN6_w',drp:'N1AEppyajPM',bankruptcy:'9DhUYSV4-zk'};
  ...
  if(services){
   const serviceVideos=[['tlsQ31IUC7s','IVA 介紹影片'],['N1AEppyajPM','DRP 介紹影片']];
